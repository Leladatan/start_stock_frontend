...
export const colorBlocks = [
  {text: "Большой выбор конкурсов в креативных индустриях"},
  {text: "Поиск и создание команды мечты"},
  {text: "Возможность задать все вопросы экспертам для уверенной победы"},
  {text: "Карьерные консультации и полезные бонусы"},
];
