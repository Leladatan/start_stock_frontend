...
export const contests: Contest[] = [
  ...
  //   category: ["Дизайн", "Графический дизайн"],
  //   applications: 40,
  ...
  // }
  {
    ...
    description: "Бизнес-Практика",
    category: ["Бизнес", "Маркетинг и Реклама", "Графический дизайн"],
    applications: 50,
    imageUrl: "https://images.unsplash.com/photo-1506748686214-e9df14d4d9d0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&q=80&w=400",
    price: 0,
    duration: 21,
    participationType: ["Командный"],
    scale: ["Межвузовский"],
    format: ["Офлайн" ,"Онлайн"],
    cases: ["Реальные "],
    workload: "Низкая",
  ...
  {
    id: 2,
    title: "Серебряный Лучник",
    description: "Серебряный Лучник",
    category: ["Бизнес", "Маркетинг и Реклама"],
    applications: 150,
    imageUrl: "https://images.unsplash.com/photo-1506748686214-e9df14d4d9d0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&q=80&w=400",
    price: 2000,
    duration: 21,
  ...
  },
  {
    id: 3,
    title: "Дизайн Цех",
    description: "Дизайн Цех",
    category: ["Графический дизайн", "Маркетинг"],
    applications: 100,
    imageUrl: "https://images.unsplash.com/photo-1506748686214-e9df14d4d9d0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&q=80&w=400",
    price: 1000,
    duration: 7,
  ...
  {
    id: 4,
    title: "Кино с человеческим лицом",
    description: "Кино с человеческим лицом",
    category: ["Кино"],
    applications: 100,
    imageUrl: "https://images.unsplash.com/photo-1506748686214-e9df14d4d9d0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&q=80&w=400",
    price: 500,
    duration: 14,
    participationType: ["Индивидуальный"],
    scale: ["Всероссийский"],
    format: ["Офлайн"],
    cases: ["Реальные"],
    workload: "Высокая",
  ...
  {
    id: 6,
    title: "Конкурс \"СОЦОБЪЕКТ\"",
    description: "Конкурс \"СОЦОБЪЕКТ\"",
    category: ["Искусство"],
    applications: 50,
    imageUrl: "https://images.unsplash.com/photo-1506748686214-e9df14d4d9d0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&q=80&w=400",
    price: 500,
